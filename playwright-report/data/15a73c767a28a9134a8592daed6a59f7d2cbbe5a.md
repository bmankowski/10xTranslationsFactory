...
- Name: Authenticated user actions >> authenticated user can access protected pages
- Location: /home/bmankowski/projects/10xTranslationsFactory/test/e2e/auth/authenticated-actions.spec.ts:5:3
...
Received string:        "http://localhost:3000/auth/login?redirectTo=%2Fprofile"
    at /home/bmankowski/projects/10xTranslationsFactory/test/e2e/auth/authenticated-actions.spec.ts:13:28
```
