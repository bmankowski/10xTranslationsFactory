...
import type { ChatMessageVM, AIMessageVM, UserAnswerVM, FeedbackResultVM } from "./viewModels";
import { Bot, User, CheckCircle, XCircle, Loader2 } from "lucide-react"; // Using lucide-react for icons
