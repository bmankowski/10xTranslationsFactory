...
const ExerciseLanguageFilter: React.FC<ExerciseLanguageFilterProps> = ({ languages, selectedLanguageId }) => {
  ...
  return (
    <LanguageFilter languages={languages} selectedLanguageId={selectedLanguageId} onFilterChange={handleFilterChange} />
  );
};
